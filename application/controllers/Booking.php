    ...
    public function tambahBooking()
{
    ...
    if ($databooking > 0) {
        $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-message" role="alert">
            Masih Ada booking buku sebelumnya yang belum diambil.<br> 
            Ambil Buku yang dibooking atau tunggu 1x24 Jam untuk bisa booking kembali 
        </div>');
        redirect(base_url());
    }
...
public function exportToPdf()
{
    ...
    // Convert to PDF
    $this->pdf->filename="bukti-booking-$id_user.pdf"; // nama file pdf yang dihasilkan
